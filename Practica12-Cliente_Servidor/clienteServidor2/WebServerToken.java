...
public class WebServerToken {
    ...
    public static void main(String[] args) {
        ...
        WebServerToken webServer = new WebServerToken(serverPort,max_t);  //Objeto webServer
    ...
    //Contructor
    public WebServerToken(int port,int max_t) {
    ...
    public void startServer() {
        ...
        //Creacion de hilos
        server.setExecutor(Executors.newFixedThreadPool(MAX_T));
        server.start();
    }
