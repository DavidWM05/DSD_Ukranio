...
public class WebServerToken {
    ...
    public static void main(String[] args) {
        ...
        WebServerToken webServer = new WebServerToken(serverPort);  //Objeto webServer
    ...
    //Contructor
    public WebServerToken(int port) {
    ...
    private byte[] buscarCadenota(byte[] requestBytes){
        ...
        return String.format("Ocurrencias de %s = %d", palabra,ocurrencias).getBytes();        
    }
