...
public class ObjectMapperUtils {
	...
	private static String countryStr = "{\"name\":\"India\",\"population\":135260000000,\"numberOfProvinces\":29,\"developed\":true}";//Estructura de objeto json

	public static void objectToJsonString() throws JsonProcessingException {
		String countryAsString = objectMapper.writeValueAsString(country);		//Toma un objeto como argumento y devuelve el json generado como cadena
		System.out.println("objectToJsonString : " + countryAsString + "\n");
	}

	public static void objectToJsonInFile() throws IOException {
		//Toma dos argumentos, un objeto de archivo en el que debe escribirse json 
		//y un objeto de origen que debe serializarse
	...
	public static void readJsonStringAsMap() throws IOException {
		//	Una cadena Json se puede analizar y transformar en un java.util.map
		Map<String, Object> jsonStringToMap = objectMapper.readValue(countryStr,new TypeReference<Map<String, Object>>(){});
	...
	public static void jsonStringWithDateToObject() throws IOException {
		...
		String infoAsString = "{\"country\":{\"name\":\"India\","
				...
				+ "\"developed\":true},\"now\":\"sáb. ene 07 19:52:40-0600 2023\"}";
