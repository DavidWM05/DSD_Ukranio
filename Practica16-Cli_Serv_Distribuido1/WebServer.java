...
public class WebServer {
    ...
    private byte[] calculateResponse(byte[] requestBytes) {
        ...
        System.out.println("\t Despues de deserialize: " + objeto);
        System.out.println("\t ======================================\n");
        ...
        //for (String number : stringNumbers) {
            BigInteger bigInteger = new BigInteger(objeto.a);
            result = result.multiply(bigInteger);
            
            BigInteger bigInteger2 = new BigInteger(objeto.b);
            result = result.multiply(bigInteger2);
        //}
