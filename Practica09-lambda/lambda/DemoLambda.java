/*
*	Lea y comprenda los códigos disponibles en:
*
...
*	Ejercicio 1
*
*	Posteriormente acceda al siguiente link:
*
*	https://www.ecodeup.com/ejemplos-practicos-de-expresiones-lambda-en-java-8/
*
*	Cree el programa DemoLambda.java (sin incluir la clase Alumno) para ejecutar
*	todas las operaciones mostradas en la página, comprenda su funcionamiento y 
*	comente el código donde considere necesario. Finalmente envíe el archivo 
*	DemoLambda.java a Teams (debe poderse compilar).
*/
import java.io.*;
import java.util.*;
...
public class DemoLambda{
	public static void main(String[] args) {
		...
		listaAlumnos.stream().
		filter(c -> c.getApellidos().charAt(0) == 'L' || c.getApellidos().charAt(0) == 'G').forEach(c -> System.out.println(c));
